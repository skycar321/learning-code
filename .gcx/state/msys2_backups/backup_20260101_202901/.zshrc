...
# Windows .cmd 파일을 직접 호출하여 경로 오류 방지
export PATH="/c/Users/Nam/AppData/Roaming/npm:$PATH"
claude() { cmd.exe //c "C:/Users/Nam/AppData/Roaming/npm\\claude.cmd" "$@"; }
gemini() { cmd.exe //c "C:/Users/Nam/AppData/Roaming/npm\\gemini.cmd" "$@"; }
codex() { cmd.exe //c "C:/Users/Nam/AppData/Roaming/npm\\codex.cmd" "$@"; }
# <<< GCX npm CLI Tools
